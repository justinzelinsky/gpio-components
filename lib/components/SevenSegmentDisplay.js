...
class SevenSegmentDisplay {
    ...
    setDisplay(displayNumber) {
        return __awaiter(this, void 0, void 0, function* () {
            const zeroValue = getBinaryValue_1.default(displayNumber % 2);
            const oneValue = getBinaryValue_1.default((displayNumber >> 1) % 2);
            const twoValue = getBinaryValue_1.default((displayNumber >> 2) % 2);
            const threeValue = getBinaryValue_1.default((displayNumber >> 3) % 2);
            return Promise.all([
